          ...
          <div className="rounded-lg p-[5px]">
            {/* <Dropzone onDrop={onDrop}>
              {({ getRootProps, getInputProps }) => ( */}
                <div
                  className="relative w-[60px] h-[60px] mb-2 ml-auto border-[1px] border-[#307730] rounded-full"
                  // {...getRootProps()}
                >
                  <img
            ...
            <div className="flex w-full justify-between">
              <div className="w-[46%]">
                <select
                  ...
                  // error={errors?.gender}
                >
                  <option value="male">organization1</option>
                  <option value="female">organization2</option>
